...
/// 하지만 내가 만든 BASE36 인코딩/디코딩 테이블: 숫자(10개) + 영문자(A~Z)
///========================================================================================
...
final List<String> _B36_VAL =
    ...
    List<String>.generate(26, (index) => String.fromCharCode(index + 65));      // A ~ Z


/// Base36 Forward Lookup(키:int, 값:String), 예) B32F[11] = 'B'
final Map<int, String> B36F = Map<int, String>.fromIterables(_B36_KEY, _B36_VAL);

/// Base32 Backward Lookup(키:String, 값:int) 예) B32B['V'] = 31
final Map<String, int> B36B = Map<String, int>.fromIterables(_B36_VAL, _B36_KEY);
///========================================================================================
...
QRInfo getValidQRInfo(String rawQR) {
  ...
  if (org != "H2" || !["1", "A", "W"].contains(dept)) return returnValue;   // 복지팀 = 'W'
