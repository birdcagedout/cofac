...
final Map<String, String> staffTable =
    Map.fromIterables(staffIDList, staffNameList);

/// 직원 소속팀 lookup table
final Map<String, String> teamTable =
    Map.fromIterables(staffNameList, staffTeamList);

/// 직원별 Color lookup table (code -> color)
// final Map<String, Color> colorTable =
//     Map.fromIterables(staffIDList, edgeColorList);
...
// 식당 스캔 여부 저장
final Map<String, bool> doneStores = {
  for (var store in storeList) store: false
};
